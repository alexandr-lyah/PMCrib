...
AFC_GLUE_STYLESHEET = "http://static.ibsrv.net/dfp/test/css/afc_glue.css";
...
function hasGlueCssFrom(contextNode) {
	...
	function getAttributionLink() {
		...
		return '<a target="_blank" href="'+fu+'" class="attributionLink" style="color:#444;font-weight:inherit;font-size:inherit;line-height:inherit;text-decoration:none">Ads by Google</a>';
	}//getAttributionLink
	...
	function getAdsenseUnitsHTML(google_ads, activeAdRef, bypassInventoryIncrement) {
			...
			if (!activeAdRef.shouldRenderClean) {
				...
				{
					s += '<div class="adsByGoogle" style="position:absolute;bottom:auto;top:2px;left:6px;z-index:2;font-size:11px;text-align:left;'+activeAdRef.unit.adsByGoogleFontWeight+'">'+getAttributionLink()+'</div>';
				} else {
					s += '<div class="adsByGoogle" style="position:absolute;bottom:0px;top:2px;left:6px;z-index:2;font-size:11px;text-align:left;'+activeAdRef.unit.adsByGoogleFontWeight+'">'+getAttributionLink()+'</div>';
				}
			} else {
			 ...
			 */
			s += '<div class="afc_text_ad ad-count-'+google_ads.length+'" style="padding:0;margin:0;'+ activeAdRef.unit.adUnitsMarginTop + activeAdRef.unit.adUnitsMarginRight +activeAdRef.unit.adUnitsMarginBottom+activeAdRef.unit.adUnitsMarginLeft+'">';			 
				for(var i=0; i < google_ads.length; ++i) {
					...
					if (activeAdRef.shouldRenderClean) {
						...
						'<div style="'+activeAdRef.unit.hideLink+activeAdRef.unit.textAlign
						...
						'"><span class="visibleUrl" style="font-weight:normal;'+(activeAdRef.unit.nowrapLink)+'color:#'+activeAdRef.ad_url+';'+vizurlDecoration+urlFSize+urlFont+activeAdRef.unit.vUrlDisplay+'">' +
  ...
  //  it must not reference global variables that may have changed
	...
	function adornAds(theads) {
		...
		for (var theadc=0; thead=theads[theadc]; theadc++) {
			thead.globalcount = window.adCounter;
			window.adCounter++;
		}
	}//adornAds
 ...
 function BaseGoogAdUnit(
    ...
    this.adUnitsMarginTop = (linesPaddingConfig && linesPaddingConfig.adUnitsTop)?("margin-top:"+linesPaddingConfig.adUnitsTop+"px;") : "";
    this.adUnitsMarginRight = (linesPaddingConfig && linesPaddingConfig.adUnitsRight)?("margin-right:"+linesPaddingConfig.adUnitsRight+"px;") : "";
    this.adUnitsMarginBottom = (linesPaddingConfig && linesPaddingConfig.adUnitsBottom)?("margin-bottom:"+linesPaddingConfig.adUnitsBottom+"px;") : "";
    this.adUnitsMarginLeft = (linesPaddingConfig && linesPaddingConfig.adUnitsLeft)?("margin-left:"+linesPaddingConfig.adUnitsLeft+"px;") : "";
    this.adsByGoogleFontWeight = (linesPaddingConfig && linesPaddingConfig.adsByGoogleFontWeight)?'font-weight:'+linesPaddingConfig.adsByGoogleFontWeight+';':'font-weight:bold;';
    this.hideLink = (linesPaddingConfig && linesPaddingConfig.hideLink)?'display:none;':'';
    this.nowrapLink = (linesPaddingConfig && linesPaddingConfig.nowrapLink)?'white-space:nowrap;':'';
...
if (!window.AD_UNITS) {
 AD_UNITS = {
	...
	"728x90":	new BaseGoogAdUnit(
					728,90,4,"horizontal",15,null,10,170,10,10,null,null, //modified
					{
						1: new BaseGoogAdUnit(
							728,90,4,"horizontal",null,null,25,700,14,16,"center",{lineOneTop: 15}
						),
	...
	"468x60":	new BaseGoogAdUnit(
					468,60,1,"horizontal",null,null,16,450,11,12,"center", {
								lineOneTop: 0,
								lineTwoTop: 3,
								lineThreeTop: 0
							}
	...
	"238x60": new BaseGoogAdUnit(238,60,1,"vertical",15,0,10),
	"300x50": new BaseGoogAdUnit(300,50,1,"vertical",5,0,11, null, null, 10,"center",{adsByGoogleFontWeight:'normal', hideLink:1}),
	"320x50": new BaseGoogAdUnit(320,50,1,"vertical",5,0,11, null, null, 10,"center",{adsByGoogleFontWeight:'normal', hideLink:1}),
	"200x90": new BaseGoogAdUnit(200,90,1,"vertical",15,0,11, null, null, 10 , null , { nowrapLink:1 }),
	"180x90": new BaseGoogAdUnit(180,90,1,"vertical",15,0,11, null, null, 10 , null, { nowrapLink:1 }),
	"160x90": new BaseGoogAdUnit(160,90,1,"vertical",10,0,11, null, null, 10, null, {lineOneTop:0, adUnitsTop:5 , nowrapLink:1 }), //Modified
	...
	"160x600": new BaseGoogAdUnit(
							160,600,5,"vertical",0,0,14,null,10,12,null,{lineOneTop: 15, lineTwoTop:4,lineThreeBottom: 5 , adUnitsTop:5 , nowrapLink:1},
							{							
								1: new BaseGoogAdUnit(
								...
								4: new BaseGoogAdUnit(
									160,600,5,"vertical",0,0,14,null,10,13,"left", {
										lineOneTop: 35, /* 40 */
										lineTwoTop: 4,
										lineThreeTop: 8,
										lineThreeBottom: 0,
	...
	"160x240": new BaseGoogAdUnit(
						160,240,2,"vertical",20,0,12,null,10,12,null,{ nowrapLink:1 },
						{
							1: new BaseGoogAdUnit(
	...
	"336x280": new BaseGoogAdUnit(
						336,280,4,"squarecompact",10,0,13,null,11,12,null,{adUnitsTop:10},
						{
							1: new BaseGoogAdUnit(
	...
	"350x200": new BaseGoogAdUnit(
						350,200,3,"square",3,0,11,null,10,10,null,{
                            lineOneTop: 2,
							lineTwoTop: 0,
							lineThreeTop: 0,
							lineThreeBottom: 0,
	...
	"300x250": new BaseGoogAdUnit(
						300,250,4,"square",3/* 10 */,0,11,240,10,11,null,{lineOneTop:2, adUnitsTop:14}, //Modified
						{
							1: new BaseGoogAdUnit(
								300,250,4,"square",0,0,25,240,14,16,"center", {
									lineOneTop: 70,
									lineTwoTop: 10,
									lineThreeTop: 10,
									lineThreeBottom: 90
							...
							3: new BaseGoogAdUnit(
								300,250,4,"square",0,0,11,null,11,null,"left", {
									lineOneTop: 15,
                                    adUnitsTop:5,
									lineTwoTop: 2,
									lineThreeTop: 4,
	...
	"250x250": new BaseGoogAdUnit(250,250,3,"square",20,0,12,null,10,11,null,null,
					    {
							2: new BaseGoogAdUnit(
								250,250,2,"square",20,0,14,null,10,11
							)
				        }        
                   ), /* fix 2 -- 3 */
	"200x200": new BaseGoogAdUnit(200,200,2,"square",15,5,12, null, null, null, null , {nowrapLink:1} ),
