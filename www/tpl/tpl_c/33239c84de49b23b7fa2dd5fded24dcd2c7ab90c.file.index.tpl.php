...
$_smarty_tpl->decodeProperties(array (
  ...
  'has_nocache_code' => false,
      ...
      <div class="hero-unit" style="background-image:url(' <?php echo $_smarty_tpl->getVariable('baseUrl')->value;?>
web/img/ed.jpg');
      ">
  ...
  <p>or <a href="pitch.php" style="color:#5bb75b;"><strong>Pitch your own Crib</strong></a></p>
      ...
      <div id="contresults" style="display:none;">
        ...
        <p style="color:#99999; font-size:20px; "> <em style="color:#c2c2c2">Results for </em> <em>Covent Garden, London </em>
